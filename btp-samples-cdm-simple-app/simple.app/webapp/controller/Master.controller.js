sap.ui.define([
	...
	return BaseController.extend("btp.samples.cdm.simple.app.controller.Master", {
		...
		onInit : function () {
            ...
            this.byId("titleImage").setSrc(sap.ui.require.toUrl("btp/samples/cdm/simple/app/images/logo_ui5.png"));            
		...
		onOpenViewSettings : function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "btp.samples.cdm.simple.app.view.ViewSettingsDialog",
					controller: this
