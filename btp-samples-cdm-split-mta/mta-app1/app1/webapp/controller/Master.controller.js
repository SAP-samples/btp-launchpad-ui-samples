sap.ui.define([
	...
	return BaseController.extend("btp.samples.cdm.split.mta.app1.controller.Master", {
		...
		onInit : function () {
            ...
            this.byId("titleImage").setSrc(jQuery.sap.getResourcePath("btp/samples/cdm/split/mta/app1/images/logo_ui5.png"));            
		...
		onOpenViewSettings : function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "btp.samples.cdm.split.mta.app1.view.ViewSettingsDialog",
					controller: this
